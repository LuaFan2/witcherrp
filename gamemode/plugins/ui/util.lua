surface.CreateFont('ui.40', {font = 'Tahoma', size = 40, weight = 500})
surface.CreateFont('ui.39', {font = 'Tahoma', size = 39, weight = 500})
surface.CreateFont('ui.38', {font = 'Tahoma', size = 38, weight = 500})
surface.CreateFont('ui.37', {font = 'Tahoma', size = 37, weight = 500})
surface.CreateFont('ui.36', {font = 'Tahoma', size = 36, weight = 500})
surface.CreateFont('ui.35', {font = 'Tahoma', size = 35, weight = 500})
surface.CreateFont('ui.34', {font = 'Tahoma', size = 34, weight = 500})
surface.CreateFont('ui.33', {font = 'Tahoma', size = 33, weight = 500})
surface.CreateFont('ui.32', {font = 'Tahoma', size = 32, weight = 500})
surface.CreateFont('ui.31', {font = 'Tahoma', size = 31, weight = 500})
surface.CreateFont('ui.30', {font = 'Tahoma', size = 30, weight = 500})
surface.CreateFont('ui.29', {font = 'Tahoma', size = 29, weight = 500})
surface.CreateFont('ui.28', {font = 'Tahoma', size = 28, weight = 500})
surface.CreateFont('ui.27', {font = 'Tahoma', size = 27, weight = 400})
surface.CreateFont('ui.26', {font = 'Tahoma', size = 26, weight = 400})
surface.CreateFont('ui.25', {font = 'Tahoma', size = 25, weight = 400})
surface.CreateFont('ui.24', {font = 'Tahoma', size = 24, weight = 400})
surface.CreateFont('ui.23', {font = 'Tahoma', size = 23, weight = 400})
surface.CreateFont('ui.22', {font = 'Tahoma', size = 22, weight = 400})
surface.CreateFont('ui.20', {font = 'Tahoma', size = 20, weight = 400})
surface.CreateFont('ui.19', {font = 'Tahoma', size = 19, weight = 400})
surface.CreateFont('ui.18', {font = 'Tahoma', size = 18, weight = 400})
surface.CreateFont('ui.17', {font = 'Tahoma', size = 15, weight = 550})
surface.CreateFont('ui.15', {font = 'Tahoma', size = 15, weight = 550})
surface.CreateFont('ui.witcher', {font = 'Morpheus Cyr', size = 22})
...
function ui.Request(title, text, yes, no, cback)
	if type(yes) == 'function' then
		cback = yes
		yes = 'Yes'
		no = 'No'
	end
		...
		function self:AddPlayer(pl)
			local p = ui.Create('DButton', function(self, p)
				...
				function self:Paint(w, h)
					...
					local col = pl:GetJob().color and pl:GetJob().color or team.GetColor(pl:Team())
